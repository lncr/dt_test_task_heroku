...
class PostTest(APITestCase):
    def setUp(self):
        self.user1 = User.objects.create_user(
            email="test1@mail.com", username="test_user1", password="Test1234"
        )
        self.user2 = User.objects.create_user(
            email="test2@mail.com", username="test_user2", password="Test1234"
        )
        ...
        self.comment1 = Comment.objects.create(
            post=self.post1, content="test content", author=self.user2
        )
        self.comment2 = Comment.objects.create(
            post=self.post2, content="test content", author=self.user1
        )
    ...
    def test_update_comment(self):
        url = reverse(
            "comment_detail_url",
            kwargs={"post_id": self.post1.id, "id": self.comment1.id},
        )
